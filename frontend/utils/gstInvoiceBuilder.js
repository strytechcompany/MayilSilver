...
const buildInvoiceBody = (transaction, summary, settings, logoSrc, profile, signatureSrc = '') => {
  ...
  <div class="details-grid">
    <div class="detail-box left">
      ...
      <div class="d-row"><span class="d-lbl">Address</span><span class="d-colon">:</span><span class="d-val">${escHtml(transaction.address || '-')}</span></div>
      <div class="d-row"><span class="d-lbl">GST Number</span><span class="d-colon">:</span><span class="d-val">${escHtml(transaction.gstNumber || '-')}</span></div>
    </div>
